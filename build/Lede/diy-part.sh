...
rm -rf golang && git init && git remote add origin https://github.com/openwrt/packages.git && git config core.sparsecheckout true && echo lang/golang/ >>.git/info/sparse-checkout && git pull origin openwrt-23.05
popd
